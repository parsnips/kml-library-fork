namespace KMLib.Feature
{
    ...
    public class Placemark : AFeature
    {
        ...
        {
            get { return m_Geometry as KmlPoint; }
            set { m_Geometry = value; }
        }

        public LinearRing LinearRing
        {
            get { return m_Geometry as LinearRing; }
            set { m_Geometry = value; }
        }

        public LineString LineString
        {
            get { return m_Geometry as LineString; }
            set { m_Geometry = value; }
        }

        public Model Model
        {
            get { return m_Geometry as Model; }
            set { m_Geometry = value; }
        }

        public MultiGeometry MultiGeometry
        {
            get { return m_Geometry as MultiGeometry; }
            set { m_Geometry = value; }
        }

        public Polygon Polygon
        {
            get { return m_Geometry as Polygon; }
            set { m_Geometry = value; }
        }
